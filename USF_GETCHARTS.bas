VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} USF_GETCHARTS 
   Caption         =   "Get Charts"
   ClientHeight    =   5070
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   12570
   OleObjectBlob   =   "USF_GETCHARTS.frx":0000
   StartUpPosition =   1  'CenterOwner
   WhatsThisHelp   =   -1  'True
End
Attribute VB_Name = "USF_GETCHARTS"
...
For Each cPart In ws2.Range("CHR_BAS_SUB")
    Me.CB_SUBID.AddItem cPart.Value
    USF_GETCHARTS.CB_SUBID = cPart.Value
Next cPart
...
Debug.Print SLC_OBS_COL
    ...
    'text to GRAFIK
    Application.StatusBar = " >>  Copying data from .txt file..."

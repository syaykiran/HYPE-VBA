...
Application.StatusBar = " >> MgmtData.txt  :  Information about irrigation (optional)."
End Sub
...
Set COMMENT_RANGE = Range("RNG_MGMTDATA")
Set LOOK_RANGE = ThisWorkbook.Worksheets("COMMENT").Range("DESC_MGMTDATA")

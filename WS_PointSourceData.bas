...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "WS_PointSourceData"
...
Application.StatusBar = " >> PointSourceData.txt  :  Information about point sources and water abstraction (optional)."
End Sub
...
Set COMMENT_RANGE = Range("RNG_POINTSOURCEDATA")
Set LOOK_RANGE = ThisWorkbook.Worksheets("COMMENT").Range("DESC_POINTSOURCEDATA")

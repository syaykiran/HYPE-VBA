...
Application.StatusBar = " >> GeoData.txt  :  Subcatchment characteristics and flow connections between them (mandatory)."
End Sub
...
Set COMMENT_RANGE = Range("RNG_GEODATA")
Set LOOK_RANGE = ThisWorkbook.Worksheets("COMMENT").Range("DESC_GEODATA")

...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "WS_BranchData"
...
Application.StatusBar = " >> BranchData.txt  :  Bifurcations in the flow network (optional)."
End Sub
...
Set COMMENT_RANGE = Range("RNG_BRANCHDATA")
Set LOOK_RANGE = ThisWorkbook.Worksheets("COMMENT").Range("DESC_BRANCHDATA")

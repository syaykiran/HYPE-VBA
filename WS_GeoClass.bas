...
Application.StatusBar = " >> GeoClass.txt  :  SLC class definition, HRUs (mandatory)."
End Sub
...
Set COMMENT_RANGE = Range("RNG_GEOCLASS")
Set LOOK_RANGE = ThisWorkbook.Worksheets("COMMENT").Range("DESC_GEOCLASS")

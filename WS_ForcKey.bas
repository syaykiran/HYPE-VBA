...
Application.StatusBar = " >> ForcKey.txt  :  Link list between subcatchment IDs and forcing data IDs, as well as temperature observation elevations (optional)."
End Sub
...
Set COMMENT_RANGE = Range("RNG_FORCKEY")
Set LOOK_RANGE = ThisWorkbook.Worksheets("COMMENT").Range("DESC_FORCKEY")
